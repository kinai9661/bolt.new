...
export default function SettingsTab() {
  ...
  const [settings, setSettings] = useState<UserProfile>(() => {
    ...
    if (saved) {
      ...
      return {
        ...savedProfile,
        language: normalizeLanguage(savedProfile.language),
      };
    }
  ...
  useEffect(() => {
    try {
      ...
      toast.success(t('settingsTab.settingsUpdated'));
    } catch (error) {
      console.error('Error saving settings:', error);
      toast.error(t('settingsTab.settingsUpdateFailed'));
    }
  }, [settings, t]);
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => {
                ...
                toast.success(
                  t('settingsTab.notificationsStatus', {
                    status: checked ? t('settingsTab.enabled') : t('settingsTab.disabled'),
                  }),
                );
              }}
            />
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between p-2 rounded-lg bg-[#FAFAFA] dark:bg-[#1A1A1A]">
            <div className="flex flex-col">
              ...
              <span className="text-xs text-bolt-elements-textSecondary">{t('settingsTab.switchThemeDescription')}</span>
            </div>
